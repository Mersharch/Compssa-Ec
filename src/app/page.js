...
<Image src={'/hero-img.png'} alt="hero-img" fill={true} className="object-contain img-anim" />
      </div>
      </>}
...
<Image src={'/hero-alt.png'} alt="hero-img" fill={true} className="object-cover img-anim" />
      </div>
      </>}
    </main>
  );
